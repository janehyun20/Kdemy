...
//	파일 업로드 처리용 변수
	...
	public String toString() {
		return "TeacherDTO [teacher_num=" + teacher_num + ", userid=" + userid + ", username=" + username
				...
				+ finalEducation + ", schoolName=" + schoolName + ", department=" + department + ", spec1=" + spec1
				+ ", spec1_getDate=" + spec1_getDate + ", spec1_img=" + spec1_img + ", spec2=" + spec2
				+ ", spec2_getDate=" + spec2_getDate + ", spec2_img=" + spec2_img + ", spec3=" + spec3
				+ ", spec3_getDate=" + spec3_getDate + ", spec3_img=" + spec3_img + ", spec4=" + spec4
	...
	public TeacherDTO(int teacher_num, String userid, String username, String nickname, String teacher_thumbnail,
			String finalEducation, String schoolName, String department, String spec1, String spec1_getDate,
			String spec1_img, String spec2, String spec2_getDate, String spec2_img, String spec3, String spec3_getDate,
			String spec3_img, String spec4, String spec4_getDate, String spec4_img, String spec5, String spec5_getDate,
			String spec5_img, String career, Date request_date, MultipartFile thumbnailFile, MultipartFile spec1File,
			MultipartFile spec2File, MultipartFile spec3File, MultipartFile spec4File, MultipartFile spec5File,
			String spec1_y, String spec1_m, String spec1_d, String spec2_y, String spec2_m, String spec2_d,
			String spec3_y, String spec3_m, String spec3_d, String spec4_y, String spec4_m, String spec4_d,
			String spec5_y, String spec5_m, String spec5_d) {
		this.teacher_num = teacher_num;
		this.userid = userid;
		this.username = username;
		this.nickname = nickname;
